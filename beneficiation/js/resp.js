...
//script for slideshow of team picture
var myindex = 0;
carousel();
...
$(document).ready(function() {
    $('#websend').click(function() {
        ...
        if ((v1 !== "" && (v2 !== "" && v3 !== "")) && (v1 !== null && (v2 !== null && v3 !== null))) {
            $.post("https://maker.ifttt.com/trigger/contact/with/key/mXT9vs8AOdX_f9MwBI0JaPST6mGXc7ONz7u2MeGQ95E", { "value1": v1, "value2": v2, "value3": v3 },
                function() {
                    alert("Sucess");
                });
